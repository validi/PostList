 ...
 * Author     : AndroidWave
 */
public class MyExoPlayerRecyclerView extends RecyclerView {
    ...
    public MyExoPlayerRecyclerView(@NonNull Context context) {
        super(context);
        init(context);
    }
    public MyExoPlayerRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    ...
                    if (!recyclerView.canScrollVertically(1)) {
                        playVideo(true);
                        Log.e("scroll","play True");
                    } else {
                        playVideo(false);
                        Log.e("scroll","play false");
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        PlayerViewHolderExoPlayer holder = (PlayerViewHolderExoPlayer) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
